<nav id="mainnav" class="p-1 md:pt-4 md:px-0 md:w-24 min-h-full md:text-sm text-center bg-blue-900 text-white">
    <ul class="flex flex-row md:flex-col flex-wrap justify-evenly pt-1 md:pt-0">
        <li class="w-1/3 md:w-auto pb-2 md:pb-0 md:pt-2 md:pb-8 hover:text-blue-600">
        ...
        <li class="w-1/3 md:w-auto pb-2 md:pb-0 md:pb-8 hover:text-blue-600">
        ...
        <li class="w-1/3 md:w-auto md:pb-8 hover:text-blue-600">
