<header id="topbar"
    ...
    <ul class="flex flex-row flex-wrap w-full sm:w-auto justify-evenly sm:justify-end text-center sm:mt-1">
        <li class="order-1 w-1/2 sm:w-auto py-2 sm:py-0 sm:px-3">v1.0.0</li>
        <li class="order-3 sm:order-2 w-1/2 sm:w-auto sm:px-3">
            <a class="cursor-pointer hover:text-blue-600" href="#">
                {{ __('Juan M. Cortéz') }}
            </a>
        </li>
        <li class="order-4 sm:order-3 w-1/2 sm:w-auto sm:px-3">
            <a class="cursor-pointer hover:text-blue-600" href="#">
                {{ __('Your Practice Name') }}
            </a>
        </li>
        <li class="order-2 sm:order-4 w-1/2 sm:w-auto py-2 sm:py-0 sm:px-3">
            <a class="cursor-pointer hover:text-blue-600" href="#">
                {{ __('Logout') }}
            </a>
        </li>
