...
<form class="w-full text-center" method="POST" action="{{ route('patients.store') }}">
    ...
    <div class="flex flex-row items-center w-full pb-4 text-sm leading-relaxed">
        ...
        <div class="flex flex-row items-center w-3/12">
            ...
            <div class="w-1/12 font-bold">(</div>
            <div class="relative w-2/12">
                <x-forms.input name="patient.persona.phone.{{ $idx }}.area_code" classes="text-center" showerror="false"
        ...
        <div class="flex flex-row items-center w-1/12">
            ...
            <div class="w-4/12">
                <x-forms.input name="patient.persona.phone.{{ $idx }}.extension" classes="text-center" showerror="false"
                    place="00" />
            </div>
        </div>
    ...
    <div class="flex flex-row items-center w-full pt-4 text-sm leading-relaxed">
        ...
        <div class="flex flex-row items-center w-3/12 ">
            ...
            <div class="w-1/12 font-bold">(</div>
            <div class="w-2/12">
                <x-forms.input name="patient.contact.{{ $idx }}.phone.area_code" classes="text-center" showerror="false"
                    place="000" />
            </div>
            <div class="w-1/12 font-bold">)</div>
            <div class="w-2/12">
        ...
        <div class="flex flex-row items-center w-1/12">
            <div class="w-8/12 font-bold">{{ __('Extension') }}</div>
            <div class="w-4/12">
                <x-forms.input name="patient.contact.{{ $idx }}.phone.extension" classes="text-center" showerror="false"
                    place="00" />
            </div>
        </div>
        <div class="relative flex flex-row w-5/12 h-10">
    ...
    <div class="flex flex-row items-center w-full pt-4 text-sm leading-relaxed">
        ...
        <div class="flex flex-row items-center w-3/12">
            <div class="w-1/12 font-bold">+</div>
            <div class="w-2/12">
                <x-forms.input name="patient.employer.phone.international_code" classes="text-center" showerror="false"
                    place="0" />
            </div>
            <div class="w-1/12 font-bold">(</div>
            <div class="w-2/12">
    ...
    <div class="flex flex-row items-center w-full pb-4 text-sm leading-relaxed">
        ...
        <div class="relative flex flex-row w-5/12 text-left">
            ...
            <x-forms.input name="patient.employer.address.street_extended" classes="ml-4" place="Extended Address" />
        </div>
        <div class="w-1/12 pr-2 font-bold text-right">{{ __('City') }}</div>
        <div class="relative w-2/12 text-left">
