<nav id="mainnav" class="p-1 md:pt-4 md:px-0 md:w-24 min-h-full md:text-sm text-center bg-blue-900 text-white">
    <ul class="flex flex-row md:flex-col flex-wrap justify-evenly">
        <li class="w-1/3 sm:w-auto pb-2 sm:pb-0 md:pt-2 md:pb-8 hover:text-blue-600">
            <a class="text-xs cursor-pointer {{ request()->routeIs('dashboard*') ? 'font-semibold' : '' }}"
                href="{{ route('dashboard.index') }}">
                <svg class="w-8 h-8 mx-auto" aria-hidden="true" focusable="false" data-prefix="fas"
        ...
        <li class="w-1/3 sm:w-auto pb-2 sm:pb-0 md:pb-8 hover:text-blue-600">
            <a class="text-xs cursor-pointer {{ request()->routeIs('patients*') ? 'font-semibold' : '' }}"
        ...
        <li class="w-1/3 sm:w-auto pb-2 sm:pb-0 md:pb-8 hover:text-blue-600 ">
            <a class="text-xs cursor-pointer{{ request()->routeIs('billing*') ? 'font-semibold' : '' }}" href="#">
                <svg class="w-8 h-8 mx-auto mb-1" aria-hidden="true" focusable="false" data-prefix="fas"
        ...
        <li class="w-1/3 sm:w-auto md:pb-8 hover:text-blue-600">
            <a class="text-xs cursor-pointer {{ request()->routeIs('scheduler*') ? 'font-semibold' : '' }}" href="#">
                <svg class="w-8 h-8 mx-auto mb-1" aria-hidden="true" focusable="false" data-prefix="fas"
        ...
        <li class="w-1/3 sm:w-auto md:pb-8 hover:text-blue-600">
            <a class="text-xs cursor-pointer {{ request()->routeIs('eligibility*') ? 'font-semibold' : '' }}" href="#">
                <svg class="w-8 h-8 mx-auto" aria-hidden="true" focusable="false" data-prefix="fas"
        ...
        <li class="w-1/3 sm:w-auto md:pb-8 hover:text-blue-600">
            <a class="text-xs cursor-pointer {{ request()->routeIs('reports*') ? 'font-semibold' : '' }}" href="#">
                <svg class="w-8 h-8 mx-auto" aria-hidden="true" focusable="false" data-prefix="fas"
