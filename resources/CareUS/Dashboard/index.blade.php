<x-layouts.logged>
    ...
    <div class="flex flex-col items-center justify-center w-full md:space-x-10 md:flex-row">
        <div class="flex flex-row w-3/12 p-5 rounded shadow-sm bg-burntsienna-100">
            ...
            <div class="flex flex-col w-10/12">
                ...
                <div class="flex flex-row items-center justify-center mt-2 text-center">
                    ...
                    @if($stats['patientgrow30']<>0)
                        @if($stats['patientgrow30']>0)
                        <p class="w-3/12 py-1 text-xs text-green-800 bg-green-200">
                            + {{ $stats['patientgrow30'] }} %
                        </p>
                        @else
                        <p class="w-3/12 py-1 text-xs text-red-800 bg-red-200">
                            {{ $stats['patientgrow30'] }} %
                        </p>
                        @endif
                        @endif
